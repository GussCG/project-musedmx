...
import MostrarButton from '../assets/icons/arrow-down-icon.png'
...
function MenuFiltroMuseo({menuVisible, setMenuVisible}) {
    ...
    const handleFiltrar = () => {
        let filtros = {
            tematica: Object.keys(selectedFilters.tematica).filter(key => selectedFilters.tematica[key]),
            alcaldia: Object.keys(selectedFilters.alcaldia).filter(key => selectedFilters.alcaldia[key]),
            rangoPrecio
        }
        ...
        document.getElementById('nmuseos').innerHTML = `Mostrando <output><b>${museosEncontrados}</b></output> museos`
    }
    ...
    <>
        ...
        >
            ...
            <div className="filtro-menu-filter">
                ...
                <div 
                    className={`filtro-menu-filter-body ${openDropdown === 'tematica' ? 'open' : ''}`} 
                    id="tematica"
                >
                    ...
                    <div className="filtro-menu-filter-body-item">
                        <label htmlFor="tematica-3">Arte Alternativo</label>
                            ...
                            <input 
                                ...
                                name="tematica-filter" 
                                id="tematica-3" 
                                checked={selectedFilters.tematica['Arte Alternativo'] || false}
                                onChange={() => toggleCheckbox('tematica', 'Arte Alternativo')}    
                            />
                            <span className="checkmark"></span>
                        </label>
                    </div>
                    ...
                    <div className="filtro-menu-filter-body-item">
                        <label htmlFor="tematica-5">Ciencia y Tecnología</label>
                            ...
                            <input 
                                ...
                                name="tematica-filter" 
                                id="tematica-5" 
                                checked={selectedFilters.tematica['Ciencia y Tecnología'] || false}
                                onChange={() => toggleCheckbox('tematica', 'Ciencia y Tecnología')}
                            />
                            <span className="checkmark"></span>
                        </label>
                    </div>
            ...
            <div className="filtro-menu-filter">
                ...
                <div 
                    className={`filtro-menu-filter-body ${openDropdown === 'alcaldia' ? 'open' : ''}`} 
                    id="alcaldia"
                >
                    <div className="filtro-menu-filter-body-item">
            ...
            <div className="filtro-menu-rango-precios">
                <label htmlFor="rango-costo">Rango de Precios hasta $<output>{rangoPrecio}</output> MXN</label>
                <input 
                    type="range" 
                    min="0" 
                    max="100" 
            ...
            <p id="nmuseos">Mostrando <output><b>0</b></output> museos</p>
