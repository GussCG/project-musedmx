      ...
      <main id="museo-main">
        <section id="museo-section-1">
            ...
            <div className="museo-section-1-info">
                <label className="museo-section-1-info-title">
                    <h1>Museo</h1>
                    <div id="museo-card-fav-button-container">
                        <input type="checkbox" name="museo-fav" className="museo-card-fav-button" />
        ...
        <section id="museo-section-2">
                ...
                <div className="museo-section-2-calificaciones-container">
                    <div className="calificacion-container">
                        ...
                        <div className="calificacion-graph-bar">
                            <div className="calificacion-graph-bar-fill">
                            </div>
                        </div>
                    </div>
                    <div className="calificacion-container">
            ...
            <div className="museo-section-2-descripcion">
                <h1>Descripción</h1>
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean varius sagittis mi, id scelerisque urna ultrices sed. Maecenas in lobortis ligula. Cras eleifend, felis nec porttitor vulputate, dui leo ornare erat, eget maximus enim dui nec leo. Cras tempus vestibulum magna non suscipit. Praesent posuere rhoncus neque sit amet scelerisque. Nunc id justo suscipit, pellentesque augue nec, molestie sapien. Sed id turpis eget turpis fermentum euismod a id enim.
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean varius sagittis mi, id scelerisque urna ultrices sed. Maecenas in lobortis ligula. Cras eleifend, felis nec porttitor vulputate, dui leo ornare erat, eget maximus enim dui nec leo. Cras tempus vestibulum magna non suscipit. Praesent posuere rhoncus neque sit amet scelerisque. Nunc id justo suscipit, pellentesque augue nec, molestie sapien. Sed id turpis eget turpis fermentum euismod a id enim.
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean varius sagittis mi, id scelerisque urna ultrices sed. Maecenas in lobortis ligula. Cras eleifend, felis nec porttitor vulputate, dui leo ornare erat, eget maximus enim dui nec leo. Cras tempus vestibulum magna non suscipit. Praesent posuere rhoncus neque sit amet scelerisque. Nunc id justo suscipit, pellentesque augue nec, molestie sapien. Sed id turpis eget turpis fermentum euismod a id enim.
                </p>
            </div>
        ...
        <section id="museo-section-3">
            ...
            <a href="#" id="museo-section-3-ver-mas">Ver más</a>
        </section>
        <section id="museo-section-4">
            ...
            >
              {/* Aqui se obtienen los museos que a otros usuarios tambien les gustaron desde el backend */}
              <SwiperSlide className="swiper-slide">
                <MuseoCard key={museoPrueba.id} museo={museoPrueba}/>
              </SwiperSlide>
              <SwiperSlide className="swiper-slide">
                <MuseoCard key={museoPrueba.id} museo={museoPrueba}/>
              </SwiperSlide>
        ...
        <section id="museo-section-5">
            ...
            <div className="museo-section-5-crv">
                        ...
                        <div className="museo-calif-grafica">
                            <div className="museo-calif-grafica-row">
                                ...
                                <img 
                                  ...
                                  alt="Estrella" 
                                />
                                <div className="museo-calif-grafica-estrellas-fill" id="museo-calif-grafica-5-estrellas-fill"></div>
                            </div>
                            <div className="museo-calif-grafica-row">
                                <p>4</p>
                                <img 
                                  ...
                                  alt="Estrella" 
                                />
                                <div className="museo-calif-grafica-estrellas-fill" id="museo-calif-grafica-4-estrellas-fill"></div>
                            </div>
                            <div className="museo-calif-grafica-row">
                                <p>3</p>
                                <img 
                                  ...
                                  alt="Estrella" 
                                />
                                <div className="museo-calif-grafica-estrellas-fill" id="museo-calif-grafica-3-estrellas-fill"></div>
                            </div>
                            <div className="museo-calif-grafica-row">
                                <p>2</p>
                                <img 
                                  ...
                                  alt="Estrella" 
                                />
                                <div className="museo-calif-grafica-estrellas-fill" id="museo-calif-grafica-2-estrellas-fill"></div>
                            </div>
                            <div className="museo-calif-grafica-row">
                                <p>1</p>
                                <img 
                                  ...
                                  alt="Estrella" 
                                />
                                <div className="museo-calif-grafica-estrellas-fill" id="museo-calif-grafica-1-estrellas-fill"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="museo-section-5-registrar">
                    ...
                    <a href="./registrar-visita.html" id="museo-section-5-registrar-button">Registra tu visita aquí</a>
                </div>
            </div>
                ...
                <div className="museo-section-5-resena">
                    ...
                    <div className="resena-comentario-container">
                        ...
                        <div className="resena-comentario-body">
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel turpis aliquam odio condimentum convallis. In sit amet ex eu ex varius pretium id a quam. Proin faucibus turpis congue turpis ullamcorper, ac vehicula sapien volutpat. Sed placerat justo vitae neque semper, ut posuere lacus convallis. Curabitur consectetur a urna sit amet rutrum. Maecenas finibus, purus eget ultricies feugiat, lorem lacus sollicitudin enim, quis feugiat tellus lacus quis augue. Nunc sollicitudin vestibulum erat, at ullamcorper arcu finibus et. Fusce sollicitudin diam arcu, sit amet dignissim ligula pulvinar id.
                            </p>
                        </div>
                    </div>
                </div>
